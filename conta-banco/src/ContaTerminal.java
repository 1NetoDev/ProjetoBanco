...
public class ContaTerminal {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        int opcao = 0;
        String tipoConta = "Conta Corrente"; // Inicializa a variável tipoConta com um valor padrão
        ...
        System.out.println("Olá " + cliente1.nomeCliente + ", Seja muito bem vindo, sua agência é " + cliente1.agencia + ", conta " + cliente1.numeroConta +cliente1.tipoConta + " e seu saldo R$" + cliente1.saldo + " já está disponível para saque.");
